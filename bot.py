...
# If we're in attached_assets, go up one level to project root
if BASE_DIR.endswith("attached_assets"):
...
# Data directory: use /app/data in Docker (persistent volume), else local directory
...
LOG_CHANNEL_FILE = os.path.join(DATA_DIR, "log_channel.json")
